...
const TAG_COLORS: Record<NewsTag, string> = {
  '金融政策': 'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400',
  '企業業績': 'bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-400',
  '経済指標': 'bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300',
  '地政学': 'bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-400',
};
