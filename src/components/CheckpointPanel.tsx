  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-r from-amber-50 to-yellow-50 checkpoint-bg-dark rounded-lg p-4 border border-amber-200 dark:border-amber-800 mb-6">
        <h3 className="font-bold text-amber-800 dark:text-white mb-2">
          今日のチェックポイント
        </h3>
  ...
  return (
    <div className="bg-gradient-to-r from-amber-50 to-yellow-50 checkpoint-bg-dark rounded-lg p-4 border border-amber-200 dark:border-amber-800 mb-6">
      <div className="flex justify-between items-start mb-2">
        <h3 className="font-bold text-amber-800 dark:text-white">
          今日のチェックポイント
        </h3>
        {analysisTimestamp && (
      ...
      <p className="text-sm text-gray-700 dark:text-white leading-relaxed whitespace-pre-wrap">
        {checkpoint}
      </p>
    </div>
  );
