    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-blue-50 to-slate-100 main-bg-dark">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-6">
                <nav className="flex gap-4">
                  ...
                  <Link href="/portfolio" className="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300">ポートフォリオ</Link>
                </nav>
                <ThemeToggle />
                {user && (
                  <UserMenu
      ...
      <main className="w-full px-4 lg:px-8 py-8 max-w-2xl mx-auto">
        <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-sm text-blue-700 dark:text-blue-300">
          <p className="font-semibold mb-1">ポイント付与について</p>
          <ul className="space-y-0.5 text-blue-600 dark:text-blue-400">
            <li>・ 初回登録: <strong>100,000pt</strong></li>
            <li>・ 毎日ログイン: <strong>1,000pt</strong></li>
            <li>・ 予想精度ボーナス: 方向正解1銘柄につき <strong>1,000pt</strong></li>
          </ul>
        </div>
        <PortfolioPanel stockData={stockData} />
      </main>
